    ...
    def create_new_bank_account(self):
        ...
        with col2:
            ...
            if confirm_data == True and register_new_account:
                ...
                is_bank_account_name_available = self.check_if_bank_account_name_already_exists(bank_account_name=account_name)
                    ...
                    with col2:
                        ...
                        if delete_account_button and confirm_account_deletion:
                            ...
                            with col2:
                                ...
                                QueryExecutor().insert_query(query=delete_account_query, values=delete_account_values, success_message="Conta excluída com sucesso!", error_message="Erro ao excluir conta:")
