...
class Home:
    ...
    def general_information(self):
        ...
        user_passwords_quantity = query_executor.simple_consult_query(
            check_user_passwords_quantity_query, params=(logged_user, logged_user_password))
        user_passwords_quantity = query_executor.treat_simple_result(
    ...
    def password_analysis(self):
        ...
        user_passwords = query_executor.complex_consult_query(
            user_passwords_query, params=(logged_user, logged_user_password))
        user_passwords = query_executor.treat_numerous_simple_result(
            user_passwords, to_remove_list)
        ...
        for i in range(0, len(user_passwords)):
            ...
            password_strength = password_validator.check_password_strength(
                empty_password)
        ...
        with col5:
            ...
            if user_passwords_quantity >= 1:
                ...
                with st.expander(label="Análise de Senhas", expanded=True):
                    ...
                    st.success(
                        body="Senhas muito fortes: {}.".format(get_very_strong))
