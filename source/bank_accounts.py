...
class BankAccount:
    ...
    def check_if_bank_account_name_already_exists(self, bank_account_name: str):
        ...
        query_values = (bank_account_name, logged_user_name, logged_user_document)

        bank_accounts_with_parameter_name_quantity = QueryExecutor().simple_consult_query(query=bank_accounts_with_parameter_name_query, params=query_values)
        bank_accounts_with_parameter_name_quantity = QueryExecutor().treat_simple_result(value_to_treat=bank_accounts_with_parameter_name_quantity, values_to_remove=to_remove_list)
        bank_accounts_with_parameter_name_quantity = int(bank_accounts_with_parameter_name_quantity)
    ...
    def get_user_bank_accounts(self):
        ...
        bank_accounts = QueryExecutor().treat_numerous_simple_result(bank_accounts, to_remove_list)
        ...
        with col2:
            ...
            if confirm_data == True and register_new_account:
                ...
                if is_bank_account_name_available:
                    ...
                    QueryExecutor().insert_query(insert_password_query, query_values, 'Conta cadastrada com sucesso!', 'Erro ao cadastrar conta:')
    ...
    def read_bank_accounts(self):
        ...
        if user_accounts_quantity == 0:
            ...
            result_list = QueryExecutor().complex_consult_query(query=account_details_query,params=(selected_option, logged_user_name, logged_user_document))
            ...
            if confirm_selection:
                ...
                if safe_password != "" and confirm_safe_password != "" and safe_password == confirm_safe_password and is_password_valid == True:
                    ...
                    if confirm_new_bank_account_data and update_bank_account_button and account_password != "" and digital_account_password != "":
                        ...
                        QueryExecutor().insert_query(query=update_account_query, values=update_account_values, success_message="Conta atualizada com sucesso!", error_message="Erro ao atualizar conta:")
