...
name_doc_query = """SELECT nome, documento_usuario FROM usuarios WHERE login = '{}' AND senha = '{}';"""
...
check_user_passwords_quantity_query = '''SELECT count(id_senha) FROM senhas WHERE usuario_associado = '{}' and documento_usuario_associado = '{}';'''.format(logged_user, logged_user_password)